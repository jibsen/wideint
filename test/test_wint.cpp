...
TEST_CASE("wint abs", "[wint]") {
	...
	REQUIRE(abs(wint96("-1")) == wint96("1"));
	REQUIRE(abs(wint96("0x7FFFFFFFFFFFFFFFFFFFFFFF")) == wint96("0x7FFFFFFFFFFFFFFFFFFFFFFF"));
	REQUIRE(abs(wint96("0x800000000000000000000000")) == wint96("0x800000000000000000000000"));
	REQUIRE(abs(wint96("0x800000000000000000000001")) == wint96("0x7FFFFFFFFFFFFFFFFFFFFFFF"));
}
